...
const ItemDetails = () => {
  ...
  return (
    <Box className='itemDetails-container'>
      <Box className='itemDetails-box-a'>
        {/* IMAGES */}
      ...
      {/* INFORMATION */}
      <Box className='itemDetails-box-b'>
        <Tabs value={value} onChange={handleChange}>
          <Tab label='DESCRIPTION' value='description' />
          <Tab label='REVIEWS' value='reviews' />
        </Tabs>
      </Box>
      <Box className='itemDetails-box-c'>
        {value === 'description' && (
      ...
      {/* RELATED ITEMS */}
      <Box className='itemDetails-box-d'>
